...
def prediction_page():
    st.title("Capture/Upload a Tomato Leaf Image for Disease Prediction 🌿🔍")
...
def about_page():
  # About Page Header
        st.markdown("<div class='about-page'><h1 class='about-title'>About the Tomato Plant Disease Classification System</h1></div>", unsafe_allow_html=True)
        ...
        # Goal
        st.markdown("<div class='section-title'>Our Goal</div>", unsafe_allow_html=True)
        st.markdown(
            """
            <div class='section-content'>
...
def home_page():
    ...
    st.title("Welcome to the Tomato Plant Disease Classification System 🌿🔍")
    st.write("""
